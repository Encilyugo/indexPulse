...
极简 A 股估值日报，每个交易日 09:00 开盘前（北京时间）推送沪深300、中证500、上证红利的 PE 百分位（10 年滚动 TTM）到 ntfy。对比基准是上一个交易日（不是日历昨天）。

数据源：[akshare `stock_index_pe_lg`](https://github.com/akfamily/akshare)（爬乐咕乐股，10 年完整历史 TTM PE）。
